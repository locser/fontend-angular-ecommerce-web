...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.shopFormService.getCreditCardMonths(1).subscribe((data) => {
      ...
      // console.log(
      //   'Retrieved credit card months: ' + JSON.stringify(this.creditCardMonths)
      // );
    });
    ...
    this.shopFormService.getCreditCardYears().subscribe((data) => {
      ...
      // console.log(
      //   'Retrieved credit card years: ' + JSON.stringify(this.creditCardYears)
      // );
    });
  ...
  getStates(formGroupName: string) {
    ...
    this.shopFormService.getStates(countryCode).subscribe((data) => {
      if (formGroupName === 'shippingAddress') {
        ...
        console.log(
          `${countryCode} - states name: ${this.shippingAddressStates}`
        );
      } else {
